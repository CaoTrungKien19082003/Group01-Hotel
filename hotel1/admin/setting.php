...
<body class="bg-light">
        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Freeze Mode</h5>
                        ...
                        <p class="card-text">
                            No customer will be allowed to book hotel room, when freeze mode is turn on
                        </p>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <form id="contact_s_form">
                            <div class="modal-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="form-label fw-bold">Social links</label>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"><i class="bi bi-tiktok me-1"></i></span>
                                                        <input type="text" name="tt" id="tt_inp" class="form-control shadow-none">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">iFrame src</label>
                                                    <input type="text" name="ỉframe" id="iframe_inp" class="form-control shadow-none" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="contact_inp(contact_data)" class="btn btn-secondary shadow-none" data-bs-dismiss="modal">CANCEL</button>
                                    <button type="submit" class="btn custom-bg text-white shadow-none">SUBMIT</button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Team Managing</h5>
    ...
    <script src="script/hoteru_setting.js"></script>
</body>
</html>