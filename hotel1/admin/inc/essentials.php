<?php
    //của frontend
    define('SITE_URL','http://127.0.0.1:8080/hotel1/');
    ...
    define('ROOM_IMG_PATH',SITE_URL.'image/rooms/');
    define('USER_IMG_PATH',SITE_URL.'image/user/');
    //api postmark
    define('SENDINBLUE_API','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');
    //backend
    define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/hotel1/image/');
    ...
    function uploadImage($image,$folder){
        ...
        if(!in_array($img_mime,$valid_mime)){
            ...
            return 'inv_size'; //size bigger than 10mb (invalid)
        }
        else{
