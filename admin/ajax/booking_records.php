<?php 
    ...
    if (isset($_POST['get_bookings'])){
        ...
        AND((bo.booking_status='cancelled' AND bo.refund=1) OR (bo.booking_status='booked' AND bo.arrival=1) OR bo.booking_status='payment failed')";
        ...
        $limit_res=select($limit_query, $values, 'sss');
        ...
        while($data=mysqli_fetch_assoc($limit_res)){
            ...
            $table_data .="
                <tr>
                    ...
                    <td class='h-font-1 bg-light'>
                        <b class='h-font-1'>Amount: </b>$$data[trans_amt]
                        <br>
